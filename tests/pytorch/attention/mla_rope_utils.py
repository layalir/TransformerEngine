    ...
    class _MLARoPETriton(torch.autograd.Function):
        ...
        def forward(ctx, q, k, v, cos, sin, head_dim_nope, head_dim_rope, head_dim_v):
            ...
            rotary_fwd_q_kernel[grid_q](
                q_3d, cos, sin,
                head_dim_nope, head_dim_rope, nheads,
                b, None, None,
            ...
            rotary_fwd_kv_kernel[grid_kv](
                kv_3d, k_pos_emb, o_key, o_value, cos, sin,
                head_dim_rope, head_dim_nope, head_dim_v, nheads,
                b, None, None,
                kv_3d.stride(0), kv_3d.stride(1),
                k_pos_emb.stride(0),
        ...
        def backward(ctx, dq, dk_out, dv_out):
            ...
            rotary_bwd_kv_kernel[grid_kv](
                dk_3d, dv_3d, d_kv, d_emb, cos, sin,
                ndr, ndp, ndv, nheads,
                b, None, None,
                dk_3d.stride(0), dk_3d.stride(1),
                dv_3d.stride(0), dv_3d.stride(1),
                d_kv.stride(0),  d_kv.stride(1),
                d_emb.stride(0),
                0, 1,
            )
...
def apply_mla_rope(
    ...
    cos_table, sin_table = build_rope_tables(
        s, emb_dim=head_dim_rope, base=base, device=q.device
    )
