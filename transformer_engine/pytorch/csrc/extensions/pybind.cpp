...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("group_quantize_strided", transformer_engine::pytorch::group_quantize_strided,
        "Fused layout-permute + MXFP8 quantize for attention QKV",
        py::arg("input"), py::arg("quantizer"), py::arg("input_byte_offsets"),
        py::arg("input_stride_elems"), py::arg("rows"), py::arg("cols"),
        py::arg("num_tensors"));
